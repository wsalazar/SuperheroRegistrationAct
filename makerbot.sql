...
BEGIN TRANSACTION;
CREATE TABLE IF NOT EXISTS makerbot_users(id INTEGER PRIMARY KEY AUTOINCREMENT,email TEXT NOT NULL,name TEXT NOT NULL,password TEXT NOT NULL,username TEXT NOT NULL,register_date datetime NOT NULL,last_login datetime);
...
CREATE UNIQUE INDEX IF NOT EXISTS makerbot_users_username_uindex ON makerbot_users(username)
COMMIT;
